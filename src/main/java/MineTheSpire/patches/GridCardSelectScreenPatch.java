    ...
    public static class darkenCard{
        public static void Postfix(AbstractCard __instance, SpriteBatch sb){
            if (AbstractDungeon.screen == AbstractDungeon.CurrentScreen.GRID){
                    if (__instance instanceof AbstractToolCard){
                        Dictionary<String, Integer> recipeCost = ((AbstractToolCard)__instance).getRecipeCost();
                        ...
                        if (!AbstractToolCard.hasEnoughResources(recipeCost)){
