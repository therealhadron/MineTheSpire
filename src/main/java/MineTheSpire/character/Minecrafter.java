package MineTheSpire.character;
...
import static MineTheSpire.MinecraftMod.makeID;
import static MineTheSpire.MinecraftMod.characterPath;

import java.util.ArrayList;

public class Minecrafter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Minecrafter"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass MINECRAFTER;
        @SpireEnum(name = "MINECRAFT_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "MINECRAFT_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public Minecrafter() {
        super(NAMES[0], Enums.MINECRAFTER,
